function w05_losgeo(outfile)
%W05_LOSGEO  figures/w05-los-geometry.svg 의 기하를 계산해서 TikZ 매크로로 낸다.
%
%   matlab -batch "addpath _tools; w05_losgeo"
%
...
if nargin < 1 || isempty(outfile)
    ...
    outfile = fullfile(root, 'figures', 'src', 'w05-los-geometry-geo.tex');
end
...
fprintf(fid, '%% figures/src/w05-los-geometry-geo.tex — 손으로 고치지 않는다.\n');
fprintf(fid, '%%\n%%   matlab -batch "addpath _tools; w05_losgeo"\n%%\n');
