function w04_ssa()
%W04_SSA  W04 §4-5 「the wrap」 그림의 기하를 계산해서 figures/src/w04-ssa.tex 를 낸다.
%
%      w04_ssa
%
...
root = fileparts(here);
out  = fullfile(root, 'figures', 'src', 'w04-ssa.tex');
...
W('%% figures/w04-ssa.svg — 각의 뺄셈은 각이 아니다. ssa 가 무엇을 고치는가.\n');
W('%%\n');
W('%%   bash _tools/tikz2svg.sh figures/src/w04-ssa.tex figures/w04-ssa.svg\n');
W('%%\n');
W('%% 이 파일은 손으로 쓰지 않는다 — _tools/w04_ssa.m 이 계산해서 낸다.\n');
