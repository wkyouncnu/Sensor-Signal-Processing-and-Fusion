function w05_beta_fix()
%W05_BETA_FIX  W05 에서 크랩각으로 쓰인 \beta_c 를 \beta 로 되돌린다.
%
%      w05_beta_fix
%
...
%    W05_0_setup.m     'current %.2f m/s at %.0f deg' 로 beta_c 를 방위로 출력
%    W05 본문 84곳     beta_c = 크랩각 atan2(v,u)               <- 전혀 다른 양
%
...
%    beta   = 크랩각      (W01 1-12, W04 3-4, 그리고 W05 4-9 가 이미 이렇게 쓴다)
%
%  W05 4-9 가 이미 hat_beta / tilde_beta 를 쓰고 있었으므로, beta 로 되돌리는 것이
%  문서 안에서도 일관된다.
%
...
f    = fullfile(fileparts(here), 'lectures', ...
                'W05_Waypoint_Following_and_LOS_Guidance.md');
