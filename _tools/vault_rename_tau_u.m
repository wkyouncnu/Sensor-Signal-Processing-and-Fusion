...
%      vault_rename_tau_u
%
%  왜 — 기호 하나가 두 가지를 뜻하고 있었다 (2026-09-10, standing-orders §11-1).
%
%    tau       otter.m 158,166,168 : tau, tau_damp, tau_crossflow
%              전부 **일반화 힘** [N, N.m]
%    tau_N     W04/W05 : 요 모멘트 [N.m]      <- 위와 같은 뜻, 옳다
%    tau_u     W01/W03 : 서지 **시상수** [s]  <- 혼자 다른 뜻
%
...
%    T_<숫자> 추력            T_1, T_2   (A1 과 W04 3-6 의 배분)
%
...
F = { fullfile(root,'lectures','W01_Vessel_Kinematics_and_the_Otter_Model.md')
      fullfile(root,'lectures','W03_Surge_Speed_Control.md')
      fullfile(root,'lectures','W04_Heading_Control.md')
      fullfile(root,'_tools','verify_constants.m')
      fullfile(root,'lectures','W03_simulink','W03_vars.m')
      fullfile(root,'lectures','W03_simulink','W03_0_setup.m')
      fullfile(root,'lectures','W03_simulink','W03_1_build_surge_control.m')
      fullfile(root,'lectures','W03_simulink','W03_C_identify_plant.m')
      fullfile(root,'lectures','W03_simulink','W03_E_integral_and_derivative.m') };
