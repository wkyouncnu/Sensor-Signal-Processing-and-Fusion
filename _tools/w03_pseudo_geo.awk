# w03_pseudo_geo.awk — figures/w03-pseudo-derivative.svg 의 곡선 좌표를 계산한다.
#
...
#                                                -> Kd N   (w >> N)   평탄
#
#   사용법:  awk -f _tools/w03_pseudo_geo.awk
BEGIN {
    Kd = 2
    ...
    printf "  <!-- computed by _tools/w03_pseudo_geo.awk : Kd=%g -->\n", Kd
