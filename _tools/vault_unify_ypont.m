...
%      W02 는 y_p, W03 3-6 은 y_{\text{pont}}.
%    - y_p 는 W04 의 경로좌표계 위첨자 p ( y_e^p ) 와 글자가 같아 헷갈린다.
%    - otter.m:69 가 이 양을 y_pont 로 부른다. 코드가 이긴다 (standing-orders §10-1).
%
