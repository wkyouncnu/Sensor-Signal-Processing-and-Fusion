...
%
%  무엇을 재현하는가
%    1. W02 §2-6  back-calculation 의 고정점 I* 와 초과분 eps* = (Ki/Kaw) e
%                 "요구가 한계와 같아진다" 는 해석이 틀렸다는 표
%    2. W04 §4-9-6 ALOS 스케치의 잔여 교차항 때문에 dV > 0 인 띠의 폭,
%                 그리고 btilde = 17 deg, y_e = -1 cm 의 반례 값
%    3. W04 §H    운동학 부분만 적분했을 때 V 가 모든 표본에서 감소하는지,
%                 y_e 가 처음 음수가 되는 시각
...
%% 1. back-calculation 고정점 (W02 §2-6, §H 의 데모 플랜트)
...
fprintf('     W04 still-water U = X_ff/|X_u| = 60/77.5544 = %.4f m/s\n', 60/77.5544);
