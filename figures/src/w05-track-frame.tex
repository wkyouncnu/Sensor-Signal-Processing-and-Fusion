% figures/w05-track-frame.svg — 두 오차가 회전변환 하나에서 나온다.
%
%   bash _tools/tikz2svg.sh figures/src/w05-track-frame.tex figures/w05-track-frame.svg
%
...
\begin{scope}[shift={(122,0)}]
  ...
  \node[anchor=north west, align=left, text width=68mm, font=\scriptsize] at (0,6) {%
    ...
    The switching test of §5-6 uses it.\\[3pt]
