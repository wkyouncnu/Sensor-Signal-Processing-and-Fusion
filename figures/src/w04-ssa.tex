% figures/w04-ssa.svg — 각의 뺄셈은 각이 아니다. ssa 가 무엇을 고치는가.
%
%   bash _tools/tikz2svg.sh figures/src/w04-ssa.tex figures/w04-ssa.svg
%
% 이 파일은 손으로 쓰지 않는다 — _tools/w04_ssa.m 이 계산해서 낸다.
