function W03_S1_speed_loop(mdl)
%W03_S1_SPEED_LOOP  3주차 세 문제를 모두 푸는 하나의 모델.
%                   Solution to all three Week 3 problems in one model.
%
%   >> W03_S1_speed_loop      W03_S1.slx 를 만든다 / builds W03_S1.slx
...
%      those agree here, but Week 5 has both, and a loop written against the
