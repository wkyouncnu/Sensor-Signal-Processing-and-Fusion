...
%
%   The thrust map is provided because Week 3 is about the CONTROLLER, not
...
%   h = 0.02 s. Those come from W03_0_setup.m and must not be changed, because
%   the numbers the checker compares against were measured with them.
%
%   See also W03_CHECK, W03_0_SETUP, PROP_THRUST.
...
'%'
'%  Derived in Appendix A1 section C. Provided here so that Week 3 spends'
...
a.Text = strjoin({ ...
'WEEK 3 LABORATORY  -  CLOSE THE SPEED LOOP YOURSELF'
''
