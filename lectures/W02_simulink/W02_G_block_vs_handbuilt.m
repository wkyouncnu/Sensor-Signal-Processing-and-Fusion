...
gapW = max(abs(run_sim('W02_surge_control', V, 'Kp',V.Kp_d, 'Ki',V.Ki_d, ...
                       'Kd',60, 'c_d',1, 'pid_mode',0, 'T_final',30).y(:, c.u) - ...
                run_sim('W02_surge_control', V, 'Kp',V.Kp_d, 'Ki',V.Ki_d, ...
...
fprintf(['\n    WITH THE DERIVATIVE SWITCHED OFF THE TWO ARE ONE CONTROLLER.\n' ...
         ...
         '\n      Section 2-4 names the single parameter that separates them. The\n' ...
