...
''
'PROBLEM 2   Add I and D, built from Gain, Sum and Integrator blocks only:'
'            no PID Controller block, no Derivative block. The derivative'
'            is filtered, d = Nf (Kd e - x) with x_dot = d.'
''
