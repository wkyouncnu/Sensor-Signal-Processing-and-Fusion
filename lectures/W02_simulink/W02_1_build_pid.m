...
%  실험 하나에 모델 하나 (standing-orders §15-15). W02_C_metrics 는 W02_C_P 와
%  같은 P 루프이지만 실험 2-4 의 것이다 — 다섯 지표를 한 응답에서 읽는 데만 쓴다.
%  One model per experiment: W02_C_metrics is the same P loop as W02_C_P, and it
%  belongs to Experiment 2-4, where the five metrics are read off one response.
M = struct( ...
  'name',  {'W02_C_metrics','W02_C_P','W02_D_PD','W02_E_PID','W02_F_block_vs_hand','W02_G_noise_kick','W02_H_antiwindup','W02_I_tuning'}, ...
  'D',     {false, false, true,  true,  true,  true,  true,  true }, ...
  'I',     {false, false, false, true,  true,  true,  true,  true }, ...
  'limit', {false, false, false, false, true,  false, true,  false}, ...
  'noise', {false, false, false, false, true,  true,  false, false}, ...
  'smooth',{false, false, false, false, false, true,  false, true }, ...
  'pure',  {false, false, false, false, false, true,  false, false}, ...
  'block', {false, false, false, false, true,  false, true,  false}, ...
  'twostep',{false, false, false, false, false, false, true,  false}, ...
  'mode',  {'', '', '', '', 'back-calculation', '', 'clamping', ''}, ...
  'title', {'THE FIVE NUMBERS, READ OFF ONE RESPONSE', 'P ONLY', 'P + D', 'P + I + D', ...
            'THE PID BLOCK AGAINST THE SAME LAW BY HAND', ...
            'NOISE, AND THE CORNER OF A STEP', 'A FORCE LIMIT, AND ANTI-WINDUP', ...
            'THE TUNING ORDER'}, ...
  'sec',   {'2-4','C','D','E','F','G','H','I'});
