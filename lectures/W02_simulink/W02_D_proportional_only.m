%% W02 · 절 D — 비례제어와, 비례제어가 없애지 못하는 오차
...
%      Part 2 의 절 D 이며 §2-2 와 짝을 이룬다. §2-2 는 이 플랜트가 0 형이어서
%      비례제어만으로는 설정값에 도달할 수 없음을 보이고 그 정상상태 오차의
%      크기까지 유도했다. 이 절은 게인을 세 가지로 바꾸어 가며 그 결론을 확인한다.
%
%      This is section D of Part 2, the counterpart of §2-2, where it was shown
...
%      표 하나와 img/W02_result_P.png
%      One table and img/W02_result_P.png
