...
%W04_P1_START  4주차 실습 문제의 출발 모델을 만든다.
%              Create the starting model for the Week 4 laboratory problems.
%
%   >> W04_P1_start                 W04_P1.slx 를 만든다 / creates W04_P1.slx
%   >> W04_P1_start('W04_P1_kim')   다른 이름으로 만든다 / another name
%
%   무엇을 주고 무엇을 주지 않는가
...
''
'PROBLEM 1   Proportional only. A Step of psi_step degrees at t_step,'
'            converted to rad, error through ssa, times Kp, into tau_N.'
'            Measure the error left and the overshoot at Kp = 100 and 300.'
''
'PROBLEM 2   Add D as ONE Transfer Fcn on the error: numerator [Kd*Nf 0],'
'            denominator [1 Nf]. Show overshoot FALLS as Kd rises.'
''
'PROBLEM 3   The wrap. A Switch driven by use_ssa chooses between the error'
'            through ssa, atan2(sin(e), cos(e)), and the raw error. Command a'
'            heading across the +-180 deg seam, with and without the wrap.'
''
