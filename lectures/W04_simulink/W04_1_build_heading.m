function W04_1_build_heading()
%W04_1_BUILD_HEADING  선수방위 제어 모델 W04_heading_control.slx 를 코드로 만든다.
%                     Generate W04_heading_control.slx from code.
%
%   실행 / to run
%       W04_1_build_heading
%
...
%
%   Regenerating is safe: any existing W04_heading_control.slx is overwritten.

m    = 'W04_heading_control';
...
%  — 8주차의 기준모델과 5주차의 유도법칙이 이 자리를 실제 값으로 채운다.
%
...
%  interface what the autopilot wants: the reference model of Week 8 and the
%  guidance law of Week 5 fill this port with a real value.
...
%  미분항도 설정값 가중 c_d 를 둔 일반형으로 둔다 (2주차 §2-10). 미분게인이 곱하는 것은 r 이 아니라
...
%
%  The derivative is written in the general form of §3-4 in Week 3. What the
...
%
%  Nothing is optimised and nothing is chosen. Week 5 meets the case where
...
add_measurement(m, P.measurement, 'W04', {'psi_d','tau_N','n1','n2'}, ...
                struct('dash', true, 'weekName', 'W04  command and moment'));
...
''
'The same chain as Week 3 with one axis changed, and every conclusion of'
'Week 3 reversed by that one change.'
''
...
'   gain. Week 3 could not do this at any gain. Nothing was tuned; the'
...
''
'   In Week 3 the same term was a MASS and made things worse. Substitute'
