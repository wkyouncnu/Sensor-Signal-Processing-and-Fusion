function W05_S1_los(mdl)
%W05_S1_LOS  5주차 세 문제를 모두 푸는 하나의 모델.
%            Solution to all three Week 5 problems in one model.
%
%   >> W05_S1_los             W05_S1.slx 를 만든다 / builds W05_S1.slx
%   >> W05_check(1,'W05_S1')  1, 2, 3 을 차례로 / and 2, and 3
%
%   유도 계층 — 이 문제의 전부이다
...
%   Week 3's model held all three controllers: the plant, the autopilot and
...
%
%   See also W05_CHECK, W05_P1_START, W05_LAB_VESSEL.

if nargin < 1 || isempty(mdl), mdl = 'W05_S1'; end
...
%% ---- the Week 4 vessel, unchanged --------------------------------------
w05_lab_vessel(mdl, 340);
...
a.Text = strjoin({ ...
'SOLUTION  -  ALL THREE WEEK 5 PROBLEMS IN ONE MODEL'
''
