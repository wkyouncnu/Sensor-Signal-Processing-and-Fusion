function w05_lab_vessel(mdl, x0)
%W05_LAB_VESSEL  4주차의 선박을 5주차 실습에 그대로 넘겨 준다.
%                The Week 4 vessel, given to the Week 5 laboratory.
%
%   w05_lab_vessel(mdl, x0)
%
...
%       5주차의 문제는 유도법칙을 만드는 것이지 오토파일럿을 다시 만드는 것이
%       아니다. 4주차에서 이미 만들고 검증한 것을 다시 만들게 하면 시간이 그쪽으로
%       가고, 정작 이번 주의 내용에는 시간이 남지 않는다.
%
%       The Week 5 problems are about building a guidance law, not about
%       rebuilding an autopilot. Asking for what was already built and checked
%       in Week 4 would spend the hour there and leave none for this week's
%       subject.
%
...
%
%   See also W05_P1_START, W05_S1_LOS.
...
'%#codegen'
'%LAW  Week 4''s heading autopilot, unchanged.'
'%'
'%  tau_N = Kp ssa(psi_d - psi) - Kd r'
'%'
