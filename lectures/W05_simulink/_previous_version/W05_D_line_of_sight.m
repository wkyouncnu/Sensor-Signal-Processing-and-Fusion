%% W05 · 절 D — 시선(LOS) 유도법칙
%  W05 · Section D — the line-of-sight law
%
...
%      Part 2 의 절 D 이며 §5-4 에서 유도한 법칙을 절 C 의 법칙과 나란히 놓고
%      비교한다.
%      This is section D of Part 2, and it places the law derived in §5-4
...
%      표 하나와 img/W05_result_los.png
%      One table and img/W05_result_los.png
...
fprintf('    %s\n', repmat('-', 1, 60));
%  The LAST QUARTER, the same window W05_plot uses for the number it prints
...
f = lab_fig('W05 D  the LOS law', 1400, 450);
...
sgtitle('W05 D — one arctan turns waypoint-chasing into path following', ...
        'FontWeight','bold');
exportgraphics(f, fullfile(here,'img','W05_result_los.png'), 'Resolution', 150);
fprintf('\n  figure -> img/W05_result_los.png\n\n');
